...
#exp(
  ...
  details: [
    ...
    - Modernized build system & local development setup: Go 1.22->1.24, Bazel 6->8, WORKSPACE->MODULE.bazel, streamlined linters, containerised deps; improved bootstrap time from days to hours.
  ],
)
